...
export default function InterviewWaitingPage() {
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-12 gap-8">
          ...
          <div className="xl:col-span-4">
            <div className="relative p-6 rounded-xl border border-[#3b494b] bg-[#0d1c2d] flex flex-col gap-5 shadow-[0_0_25px_rgba(0,240,255,0.08)] overflow-hidden">
              ...
              {/* CTA */}
              <button className="relative w-full mt-2 bg-gradient-to-r from-cyan-400 to-blue-400 text-black font-bold py-3 rounded-lg hover:scale-[1.02] active:scale-[0.98] transition shadow-[0_0_20px_rgba(0,240,255,0.25)]">
                Tham gia phỏng vấn →
              </button>

              {/* footer hint */}
              <p className="text-xs text-gray-500 text-center">
                Hệ thống đã sẵn sàng kết nối bạn với interviewer
              </p>
            </div>
          </div>
        </div>
