    ...
    <header className="bg-surface border-b border-outline-variant flex justify-between items-center px-margin-desktop w-full h-16 fixed top-0 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          className="material-symbols-outlined text-on-surface-variant hover:text-primary-fixed transition-all p-2 rounded-full"
          type="button"
        >
          notifications
        </button>
        ...
        <Image
          alt="Ảnh đại diện của interviewer Nguyễn Văn Quân"
